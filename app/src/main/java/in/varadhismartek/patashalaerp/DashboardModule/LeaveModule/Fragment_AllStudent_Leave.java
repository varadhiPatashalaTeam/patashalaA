...
public class Fragment_AllStudent_Leave extends Fragment {
    ...
    public Fragment_AllStudent_Leave() {
    }
    ...
    private void initView(View view) {
        ...
        iv_backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                leaveActivity.loadFragment(Constant.LEAVE_DASHBOARD_FRAGMENT,null);
            }
        });
    }

    private void getStudentLeave() {
        apiService.getAllStudentLeave(Constant.SCHOOL_ID, Constant.EMPLOYEE_BY_ID).enqueue(new Callback<Object>() {
            @Override
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        while (key.hasNext()) {
                            ...
                            if (!jsonObjectValue.isNull("student_name")) {
                                student_name = jsonObjectValue.getString("student_name");
                            }

                            if (!jsonObjectValue.isNull("student_middle_name")) {
                                student_middle_name = jsonObjectValue.getString("student_middle_name");
                            }
                       ...
                       /*
                        String total_leaves = jsonData.getString("total_leaves");stuName.setText("Student Name : "+StrName);
