...
public class Constant {
    ...
    public static final String IMAGE_LINK = "http://13.127.95.246:8000/media/";
    // public final static String IMAGE_URL = "http://13.233.109.165:8000/media/";
    public final static String IMAGE_URL = "http://13.127.95.246:8000/media/";
    ...
    public static String SCHOOL_LOGO = "1";
    public static String EMPLOYEE_BY_ID = "";
    public static String EMPLOYEE_FULL_NAME = "";
    public static String EMPLOYEE_FNAME = "";
    public static String EMPLOYEE_LNAME = "";
    public static String EMPLOYEE_ADDHAR = "";
    public static String EMPLOYEE_ROLE = "";
    public static String EMPLOYEE_DEPARTMENT = "";
    public static String EMPLOYEE_WING = "";
    public static String EMPLOYEE_EMP_CUSTOM_ID = "";
    ...
    public static final String RV_SCHEDULE_BARRIER_LIST = "RV_SCHEDULE_BARRIER_LIST";
    public static final String RV_SCHEDULE_LIST_ROW = "RV_SCHEDULE_LIST_ROW";
    ...
    public static final String ALL_STUDENT_LEAVE = "ALL_STUDENT_LEAVE";
    ...
    public static final String EXAM_BARRIER_LIST = "EXAM_BARRIER_LIST";
    ...
    public static final String RV_HOLIDAY_LIST = "RV_HOLIDAY_LIST";
    public static final String SCHEDULE_BARRIERS_LIST = "SCHEDULE_BARRIERS_LIST";
    ...
    public static final String RV_ALL_STUDENT_LEAVE_LIST = "RV_ALL_STUDENT_LEAVE_LIST";
    ...
    public static final String RV_EXAM_NESTED_LIST = "RV_EXAM_NESTED_LIST";
    public static final String RV_EVENT_NESTED_LIST = "RV_EVENT_NESTED_LIST";
    public static final String RV_HOLIDAY_NESTED_LIST = "RV_HOLIDAY_NESTED_LIST";
    ...
    public static final String RV_TIMEYABLE_TEXTVIEW = "RV_TIMEYABLE_TEXTVIEW";
    public static final String RV_ADD_SCHEDULE_EXAM_DATE_TIME = "RV_ADD_SCHEDULE_EXAM_DATE_TIME";
    public static final String RV_ADD_SCHEDULE_CLASS_UPER = "RV_ADD_SCHEDULE_CLASS_UPER";
    public static final String RV_ADD_NESTED_SECTION = "RV_ADD_NESTED_SECTION";




    public static final String TRANSPORT_INBOX_FRAGMENT = "TRANSPORT_INBOX_FRAGMENT";
    public static final String TRANSPORT_DETAILS_FRAGMENT = "TRANSPORT_DETAILS_FRAGMENT";
    public static final String RV_TRANSPORT_BUS_LIST_ROW = "RV_TRANSPORT_BUS_LIST_ROW";
    public static final String RV_TRANSPORT_BUS_LIST_ROWA = "RV_TRANSPORT_BUS_LIST_ROWA";

    public static final String EMPLOYEE_PAYSLIP = "EMPLOYEE_PAYSLIP";
    public static final String FEES_INBOX_FRAGMENT = "FEES_INBOX_FRAGMENT";
    public static final String RV_FEES_HISTORY_ROW = "RV_FEES_HISTORY_ROW";
    public static final String RV_FEES_NESTED_CARD_ROW = "RV_FEES_NESTED_CARD_ROW";
    public static final String RV_TIMETABLE_NESTED_ROW = "RV_TIMETABLE_NESTED_ROW";


    public static final String CLASS_ROW = "CLASS_ROW";

    public static String TOOLBAR_MONTH = "";
    public static final String RV_VISITORS_INBOX_ROW = "RV_VISITORS_INBOX_ROW";
    public static final String RV_NOTIFICATION_STAFF_SEARCH_RESULT = "RV_NOTIFICATION_SEARCH_RESULT";

    public static final String FRAGMENT_VISITORS_INBOX = "FRAGMENT_VISITORS_INBOX";
    public static final String FRAGMENT_ADD_VISITIORS = "FRAGMENT_ADD_VISITIORS";
    public static final String FRAGMENT_VIEW_VISITIORS = "FRAGMENT_VIEW_VISITIORS";
    public static final String FRAGMENT_VISITIORS_GEN_PASS = "FRAGMENT_VISITIORS_GEN_PASS";

    public static final String TICKET_STAFF_INBOX_FRAGMENT = "TICKET_STAFF_INBOX_FRAGMENT";
    public static final String TICKET_STAFF_VIEW_FRAGMENT = "TICKET_STAFF_VIEW_FRAGMENT";
    public static final String RV_TICKET_STAFF_INBOX = "RV_TICKET_STAFF_INBOX";
    public static final String RV_TICKET_STAFF_CREATE_ATTACHMENT = "RV_TICKET_STAFF_CREATE_ATTACHMENT";
    public static final String RV_TICKET_VIEW_CHAT_ROW = "RV_TICKET_VIEW_CHAT_ROW";
    public static final String RV_TICKET_CHAT_ATTACHMENT = "RV_TICKET_CHAT_ATTACHMENT";
    public static final String RV_TICKET_REPLY_ATTACHMENT = "RV_TICKET_REPLY_ATTACHMENT";
    public static final String RV_TICKET_STAFF_SEARCH_RESULT = "RV_TICKET_STAFF_SEARCH_RESULT";


    public static String CurrentFragment;
    public static String FRAGMENT_VIEWTICKET = "ViewTicket";

    public static final String ADD_VEHICLE_FRAGMENT = "ADD_VEHICLE_FRAGMENT";
    public static final String ADD_ROUTE_FRAGMENT = "ADD_ROUTE_FRAGMENT";
    public static final String RV_VEHICLE_STOP_ROW = "RV_VEHICLE_STOP_ROW";
