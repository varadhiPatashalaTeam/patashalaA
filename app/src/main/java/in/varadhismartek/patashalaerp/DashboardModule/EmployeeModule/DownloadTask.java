...
public class DownloadTask {
    ...
    public DownloadTask(Context context, String downloadUrl) {
        ...
        Log.i(TAG+"PDF**", downloadFileName);
            ...
            try {
                ...
                if (outputFile != null) {
                    ...
                    alertDialogBuilder.setNegativeButton("Open report",new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                          /*  File pdfFile = new File(Environment.getExternalStorageDirectory() + "/PatashalaErp/" + downloadFileName);  // -> filename = maven.pdf
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (c.getResponseCode() != HttpURLConnection.HTTP_OK) {
                    ...
                    System.out.println("downloadUrl***"+downloadUrl+ c.getResponseMessage());
                }
                //Get File if SD card is present
                if (new CheckForSDCard().isSDCardPresent()) {
                    apkStorage = new File(Environment.getExternalStorageDirectory() + "/" + "PatashalaErp");
                } else
           ...
           /* try {
                ...
                if (!outputFile.exists()) {
                    outputFile.createNewFile();
                    System.out.println("odBackground**"+outputFile.createNewFile());
                    Log.e(TAG, "File Created");
                }
